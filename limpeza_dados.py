...
df = df.dropna(subset=['cpf']) # Remove registro com cpf nulo
...
df['endereco'] = df['endereco'].fillna('estado não informado')
...
print('Quantidade de registros removendo as duplicatas:', len(df))
